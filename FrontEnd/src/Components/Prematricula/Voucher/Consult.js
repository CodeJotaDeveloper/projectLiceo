...
export const Consult = () => {
    ...
    return (
        <div className="contentConsult">
            <h1 className="titleConsult">Consultar Por Prematricula</h1>
            ...
            <div ref={printPDF} style={{ width: '100%' }} className="contentVoucher">
                <div className="headerLiceo">
                    ...
                    <div className="boxInformation">
                        ...
                        <p className="textVoucher">Periodo: {Period}</p>
                        <p className="textVoucher">Fecha: {new Date(createdAt).toLocaleDateString()}</p>
                    </div>
                </div>
                ...
                <div className="boxVoucher">
                    <div className="columVoucher">
                        {update ? <input type='text' placeholder="Cédula" className='updateTex' value={Cedula_Student} onChange={(event) => setCedula_Student(event.target.value)} /> : <p className="textComp"> <b>Cédula:</b> {Cedula_Student}</p>}
                        {update ? <input type='text' placeholder="Nombre" className='updateTex' value={NameStudent} onChange={(event) => setName_Student(event.target.value)} /> : <p className="textComp"> <b>Nombre: </b>{NameStudent}</p>}
                        {update ? <input type='text' placeholder="Primer Apellido" className='updateTex' value={Primer_Apellido_Student} onChange={(event) => setPrimer_Apellido_Student(event.target.value)} /> : <p className="textComp"> <b>Primer Apellido:</b> {Primer_Apellido_Student}</p>}

                    </div>
                    <div className="columVoucher">
                        {update ? <input type='text' className='updateTex' value={Segundo_Apellido_Student} onChange={(event) => setSegundo_Apellido_Student(event.target.value)} /> : <p className="textComp"> <b>Segundo Apellido:</b> {Segundo_Apellido_Student}</p>}
                        {update ? <input type='text' className='updateTex' value={fecha_nacimiento_iso} onChange={(event) => setFecha_nacimiento(event.target.value)} /> : <p className="textComp"> <b>Fecha Estudiante:</b> {fecha_nacimiento_iso}</p>}
                        {update ?
                            ...
                            : <p className="textComp"> <b>Intitución:</b> {Institucion_Procedencia_Student}</p>}
                        {/* {update ? <input type='text' className='updateTex' value={Institucion_Procedencia_Student} conChange={(event) => setInstitucion_Procedencia_Student(event.target.value)}/> : <p className="textComp"> <b>Intitución:</b> {datapre.Institucion_Procedencia_Student}</p>}  */}
                    </div>
                </div>
                <p className="titleVoucherD"> <b>Datos del Encargado</b></p>
                <div className="boxVoucher">
                    <div className="columVoucher">
                        {update ? <input type='text' className='updateTex' value={Cedula_Legal_Manager} onChange={(event) => setCedula_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Cédula:</b> {Cedula_Legal_Manager}</p>}
                        {update ? <input type='text' className='updateTex' value={Name_Legal_Manager} onChange={(event) => setName_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Nombre: </b>{Name_Legal_Manager}</p>}
                        {update ? <input type='text' className='updateTex' value={Primer_Apellido_Legal_Manager} onChange={(event) => setPrimer_Apellido_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Primer Apellido:</b> {Primer_Apellido_Legal_Manager}</p>}
                        {update ? <input type='text' className='updateTex' value={Segundo_Apellido_Legal_Manager} onChange={(event) => setSegundo_Apellido_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Segundo Apellido:</b> {Segundo_Apellido_Legal_Manager}</p>}
                    </div>
                    <div className="columVoucher">
                        {update ? <input type='text' className='updateTex' value={Number_Phone_Legal_Manager} onChange={(event) => setNumber_Phone_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Teléfono:</b> {Number_Phone_Legal_Manager}</p>}
                        {update ? <input type='text' className='updateTex' value={Email_Legal_Manager} onChange={(event) => set_Email_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Correo:</b> {Email_Legal_Manager}</p>}
                        {update ? <input type='text' className='updateTex' value={Address_Legal_Manager} onChange={(event) => setAddress_Legal_Manager(event.target.value)} /> : <p className="textComp"> <b>Dirección:</b> {Address_Legal_Manager}</p>}
                    </div>
                </div>
            </div>
            <div className="ButtonVoucher">
                <button className="btnVoucher" onClick={generatePDF}>Imprimir</button>
                {/* {datapre.username === user?.username && (
