...
export const enviarCorreoConfirmacionPrematricula = async (prematriculaSaved) => {
    const config = {
    ...
    const mensaje = {
        ...
        subject: `Liceo La Virgen Proceso de Prematrícula periodo: ${prematriculaSaved.Period}.`,
        html: `
            <div style="display: grid; justify-content: center; align-items: center;">
            <p style="color:coral; font-family: Arial, Helvetica, sans-serif; font-size: 25px;">PROCESO DE PREMATRÍCULA </p>
            <div>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Estimado(a) ${prematriculaSaved.Name_Legal_Manager}, el proceso de prematricula se encuentra en estado (${prematriculaSaved.status}).</p>
