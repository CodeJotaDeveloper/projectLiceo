...
export const enviarCorreoRecuperarClave = async (email, password) => {
    ...
    const mensaje = {
        ...
        to: email,
        subject: 'Liceo La Virgen-Restablecer contraseña',
        html: `
            <div style="display: grid; justify-content: center; align-items: center;">
            <p style="color:coral; font-family: Arial, Helvetica, sans-serif; font-size: 25px;">ALERTA CONTRASEÑA DE USO CONFICENCIALIDAD</p>
            <div>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Estimado usuario, se ha generado una contraseña para ingresar a la aplicación del Liceo La Virgen.</p>
                <b><p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">La contraseña es: ${password} </p></b>
                <b><p style="font-size: 15px; font-family: Arial, Helvetica, sans-serif;">Recuerde cambiar su contraseña, luego de ingresar sesion en la opción de su perfil o cuenta.</p></b>
