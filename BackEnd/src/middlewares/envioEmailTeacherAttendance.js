...
export const enviarCorreoConfirmacionContacto = async (TeacherAttendanceSaved) => {
    const config = {
    ...
    const mensaje = {
        ...
        to: TeacherAttendanceSaved.emailLegalManager,
        cc: TeacherAttendanceSaved.emailTeacher,
        subject: `Liceo La Virgen Alerta Informe de Asistencia del estudiante.`,
        html: `
            <div style="display: grid; justify-content: center; align-items: center;">
            <p style="color:coral; font-family: Arial, Helvetica, sans-serif; font-size: 25px;">REPORTE DE ASISTENCIA</p>
            <div>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Estimado(a) Encargado(a) Legal, se le notifica el reporte de asistencia del estudiante de la materia: (${TeacherAttendanceSaved.subject}).</p>
                <b><p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;"></p></b>
                <b><p style="font-size: 23px; font-family: Arial, Helvetica, sans-serif;">Los datos recibidos del reporte de asistencia: </p></b>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Cédula del estudiante: ${TeacherAttendanceSaved.Cedula_Student}</p>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Nombre: ${TeacherAttendanceSaved.NameStudent}</p>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Primer apellido: ${TeacherAttendanceSaved.Primer_Apellido_Student}</p>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Segundo apellido: ${TeacherAttendanceSaved.Segundo_Apellido_Student}</p>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Fecha: ${TeacherAttendanceSaved.fecha}</p>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Asignatura: ${TeacherAttendanceSaved.subject}</p>                
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Tipo de ausencia: ${TeacherAttendanceSaved.absence}</p>
                <p style="font-size: 20px; font-family: Arial, Helvetica, sans-serif;">Cantidad: ${TeacherAttendanceSaved.cantidad}</p>
                

                <p style="font-size: 25px; font-family: Arial, Helvetica, sans-serif;">Para más información puede comunicarse al Liceo La Virgen</p>
